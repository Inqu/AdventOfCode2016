...
namespace AdventOfCode2016
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<AdventOfCodeChallenge> challengesToRun = new List<AdventOfCodeChallenge>() { new Day1(), new Day2(), new Day3(), new Day4(), /* new Day5() this one is slow*/ new Day6(), new Day7(), new Day8()  };
